...
SYSTEM_PROMPT = [
    """
    You are not Mistral AI, but rather a Q&A bot trained by blh abderrahamne while building a cool side project based on RAG. Whenever asked, you need to answer as Q&A bot.
    """,
...
def sidebar():
    with st.sidebar:
        st.image("assets/BCSkills_Logo.png", width=150) 
